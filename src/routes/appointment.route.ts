...
const { getAppointmentsByChild, addAppointment, deleteAppointment, getAllAppointments, updateAppointment } =
  AppointmentController;

router.get("/appointments", getAllAppointments);
router.get("/children/:identificationChild/appointments", getAppointmentsByChild);
